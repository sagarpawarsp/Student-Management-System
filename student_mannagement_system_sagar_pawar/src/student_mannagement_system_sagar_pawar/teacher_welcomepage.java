...
public class teacher_welcomepage extends JFrame implements ActionListener
{
...
JButton sec,tre,sg,cancle;
  ...
  mbar=new JMenuBar();
   ...
   setIconImage(new ImageIcon("images/downlode.jpg").getImage());
     sec=new JButton("StudentList");
     tre=new JButton("teachertimetable");
     sg=new JButton("gradeandassingment");
...
p1=new JPanel();
l1=new JLabel("WELCOME TO 'SURYA HOUSING SOCIETY'");
...
{  
  ...
  if(ae.getActionCommand()=="StudentList")
     {
        new StudentProgressTracker(); 
             }
  if(ae.getActionCommand()=="teachertimetable")
     {
       new teachertimetable();
              }
  if(ae.getActionCommand()=="gradeandassingment")
     {
    new gradeandassingment();
     }
